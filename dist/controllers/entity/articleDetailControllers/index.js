...
ArticleDetailControllers.create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { cover_letter, cover_letter_file_link, isFunding, isMaterial, material_file_link, isCoding, code_file_link, isData, data_file_link, isHuman, isBoradApproval, approvalDetails, } = req.body;
