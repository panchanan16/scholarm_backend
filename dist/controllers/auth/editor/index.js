...
_a = EditorAuthControllers;
// Login method
EditorAuthControllers.login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Find admin by email
        const admin = yield app_1.prisma.editor.findUnique({
        ...
        // Verify password
        const isPasswordValid = yield bcryptjs_1.default.compare(password, admin.editor_password);
        if (!isPasswordValid) {
            res.status(401).json({
                status: false,
                message: "Invalid email or password",
        ...
        const { editor_password: _ } = admin, adminData = __rest(admin, ["editor_password"]);
        ...
        res.status(200).json({
            status: true,
            data: {
                user: Object.assign(Object.assign({}, adminData), { role: 'editor' }),
                refreshToken,
                accessToken,
            },
...
// Logout method
EditorAuthControllers.logout = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
EditorAuthControllers.updatePassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedAdmin = yield app_1.prisma.editor.update({
            where: { editor_id: id },
            data: {
...
EditorAuthControllers.setPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
EditorAuthControllers.refreshToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.default = EditorAuthControllers;
